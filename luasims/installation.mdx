...
<AccordionGroup>
  ...
  <Accordion title="Session Data" icon="timer">
    ...
    We recommend you use the **specific text formats provided **below when setting up this section to ensure a more professional setup, such as `AMOUNTOFPOINTS - Reason`for positive and negative behaviour, as well as `Title:Number` for lesson periods. This is completely optional if you wish to use your own way of formatting each section. 
  </Accordion>
</AccordionGroup>

## Discord Configuration

Under the **LuaSIMS 2.1** folder provided, there will be a <u>Settings</u> script. Please open it to continue.