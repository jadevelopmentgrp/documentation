...
<Info>
  **Login**: Users will be prompted with a login page once agreeing to jaDevelopment policies and all other conditions. 

  Users can opt to **Remember** their login details - to avoid having to login repetitively when opening the system. 
</Info>
