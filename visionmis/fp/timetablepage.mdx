...
<Tabs>
  ...
  <Tab title="Lesson Details">
    ...
    By **clicking on a lesson**, you can view the [**Lesson Overview Page**](/lessonoverviewpage)**,** providing more features such as register taking, viewing students in the lesson & more
  </Tab>
  <Tab title="Claim Lesson">
    ...
    <Note>
      For the timetable to function as intended, all information regarding each lesson should be configured through the Weekly timetable page in [**Vision Settings**](/visionsettings)
    </Note>
  </Tab>
</Tabs>
