...
<Accordion title="Student Information">
  ...
  | Account State      | Whether the student is able to access the in-game Vision system.  [___Toggled via the Users & Security page.___](/fp/usersandsecuritypage) |
...
<Accordion title="Staff Information">
  ...
  | Roleplay Name      | The name the student has set for themselves.                                                                                                    |
  | Account State      | Whether the staff member is able to access the in-game Vision system.  [___Toggled via the Users & Security page.___](/fp/usersandsecuritypage) |
  | Gender             | The gender the student picked when creating their Vision account.                                                                               |
</Accordion>
