...
<Accordion title="Student Information">
  ...
  | Account State      | Whether the student is able to access the in-game Vision system.  [**_Toggled via the Users & Security page._**](/fp/usersandsecuritypage) |
...
<Accordion title="Staff Information">
  ...
  | Roleplay Name      | The name the student has set for themselves.                                                                                                    |
  | Account State      | Whether the staff member is able to access the in-game Vision system.  [**_Toggled via the Users & Security page._**](/fp/usersandsecuritypage) |
  | Gender             | The gender the student picked when creating their Vision account.                                                                               |
</Accordion>
