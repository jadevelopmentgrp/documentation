...
<Note>
  You'll need to be able to access our [Discord Server](https://discord.gg/E4yHfQegnP) and run /retrieve D our bot to be able to download and install your purchased products if not already recieved.
</Note>
