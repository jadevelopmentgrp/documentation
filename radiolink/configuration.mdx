...
<Tabs>
  ...
  <Tab title="Channels">
    ...
    <Warning>
      Your game is **likely to get taken down** if you disable the message filtering option as it violates Roblox ToS and jaDevelopment is not responsible if this happens.
    </Warning>
    ```luau
