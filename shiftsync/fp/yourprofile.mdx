...
<AccordionGroup>
  ...
  <Accordion title="Time Off Requests" defaultOpen icon="calendar">
    ...
    Once your request is approved, **you can view its updated status** along with the details of who modified or approved your time off request.

    ![Yourprofile Timeoff3 Jp](/images/yourprofile_timeoff3.jpg)
  </Accordion>
</AccordionGroup>